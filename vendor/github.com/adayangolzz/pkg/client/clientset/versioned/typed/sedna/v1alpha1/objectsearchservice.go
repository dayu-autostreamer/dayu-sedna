...
// ObjectSearchServicesGetter has a method to return a ObjectSearchServiceInterface.
...
// objectSearchServices implements ObjectSearchServiceInterface
type objectSearchServices struct {
	client rest.Interface
	ns     string
}

// newObjectSearchServices returns a ObjectSearchServices
func newObjectSearchServices(c *SednaV1alpha1Client, namespace string) *objectSearchServices {
	return &objectSearchServices{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *objectSearchServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ObjectSearchService, err error) {
	result = &v1alpha1.ObjectSearchService{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("objectsearchservices").
		Name(name).
...
func (c *objectSearchServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ObjectSearchServiceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ObjectSearchServiceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("objectsearchservices").
...
func (c *objectSearchServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *objectSearchServices) Create(ctx context.Context, objectSearchService *v1alpha1.ObjectSearchService, opts v1.CreateOptions) (result *v1alpha1.ObjectSearchService, err error) {
	result = &v1alpha1.ObjectSearchService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("objectsearchservices").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(objectSearchService).
		Do(ctx).
		Into(result)
	return
}
...
func (c *objectSearchServices) Update(ctx context.Context, objectSearchService *v1alpha1.ObjectSearchService, opts v1.UpdateOptions) (result *v1alpha1.ObjectSearchService, err error) {
	result = &v1alpha1.ObjectSearchService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("objectsearchservices").
		Name(objectSearchService.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(objectSearchService).
		Do(ctx).
		Into(result)
...
func (c *objectSearchServices) UpdateStatus(ctx context.Context, objectSearchService *v1alpha1.ObjectSearchService, opts v1.UpdateOptions) (result *v1alpha1.ObjectSearchService, err error) {
	result = &v1alpha1.ObjectSearchService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("objectsearchservices").
...
func (c *objectSearchServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *objectSearchServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *objectSearchServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ObjectSearchService, err error) {
	result = &v1alpha1.ObjectSearchService{}
