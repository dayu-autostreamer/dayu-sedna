...
import (
	...
	gmtypes "github.com/dayu-autostreamer/dayu-sedna/pkg/globalmanager/controllers/lifelonglearning"
	...
	"github.com/dayu-autostreamer/dayu-sedna/pkg/localcontroller/trigger"
...
func (lm *Manager) evalTask(job *Job) error {
	...
	if currentType == sednav1.LLJobStageCondWaiting {
		...
		// https://github.com/dayu-autostreamer/dayu-sedna/blob/main/docs/proposals/images/incremental-learning-state-machine.png
